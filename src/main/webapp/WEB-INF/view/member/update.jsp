...
<body>
	<form:form>
		<p>
			<label>아이디:<input id="id" type="number" value="${id }" readonly="readonly" />
			</label>
		</p>
		<p>
			<label> 이메일:<input id="email" type="email" />
			</label>
		</p>
		<p>
			<label> 이름:<input id="name" type="text" />
			</label>
		</p>
		<p>
			<label> 비밀번호:<input id="password" type="password" />
			</label>
		</p>
		<p>
